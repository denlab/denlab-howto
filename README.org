...
** docker for install official doc?
   - [[https://docs.docker.com/engine/installation/linux/ubuntu/][ubuntu]]
   - [[https://docs.docker.com/engine/installation/linux/centos/][centos]]

*** storage drivers in practice
    ...
    [[https://docs.docker.com/engine/userguide/storagedriver/device-mapper-driver/][overlay]]
    [[https://docs.docker.com/engine/userguide/storagedriver/btrfs-driver/][btrfs]]
    [[https://docs.docker.com/engine/userguide/storagedriver/zfs-driver/][zfs]]
   ...
   - [[https://docs.docker.com/engine/userguide/storagedriver/zfs-driver/#image-layering-and-sharing-with-zfs][zfs]]
